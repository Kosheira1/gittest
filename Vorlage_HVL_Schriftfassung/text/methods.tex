...
\section{Interdependence between textepsilon and textepsiloneff} 
The estimation of the dielectric permittivity. If one wants to estimate the $\epsilon$ of the dielectric material 
