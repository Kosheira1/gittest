...
\begin{figure}[htbp]
	...
	\caption[Kurze Abbildungsbeschreibung]{Setup for measurements with sample and DLPCA. \protect\footnotemark} 
...
!!! Achtung noch Fehler in Graph, es ist ADC converter!!!
\begin{figure}[htbp]
	\centering
