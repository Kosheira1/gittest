...
\begin{figure}
	\includegraphics[width=\textwidth]{figures/Method/polarizationmultiple.eps}	
...
\begin{figure}
	\includegraphics[width=\textwidth]{figures/Method/Dielectric_loss/debye-modell.jpg}	
...
\subsection{Measurement of the $\epsilon$ and the tan($\delta$) for the Debye model}
