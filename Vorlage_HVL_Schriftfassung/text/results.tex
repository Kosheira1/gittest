...
\begin{figure}[htbp]
	\centering
	\centerline{\includegraphics[width=0.5\textwidth]{figures/Results/Complex/complex_permittivity_specimen}}		
...
\begin{figure}[htbp]
  \centering
  \centerline{\includegraphics[scale=0.3]{figures/Results/Spectroscopy/spectroscopywithoutbars.eps}}
...
\begin{figure}[htbp]
 \centering
 \centerline{\includegraphics[scale=0.3]{figures/Results/Spectroscopy/errorbarsbettercolor.eps}}
