...
\subsection{Airgap}
The graph in \ref{fig.airgap} shows the influence or the air gap. 
\begin{figure}[h!tb]
	\centering
...
The illustration of the height deviation proves in \ref{fig.heightdev} that it is negligible and thus has no significant influence on the results. 
 \begin{figure}[h!tb]
	\centering
