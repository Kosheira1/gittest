...
For the by the above mentioned debye-ansatz given delay of the dipole alignment one receives the following equations for the  \cite{Kuchler}. 
\begin{equation}
