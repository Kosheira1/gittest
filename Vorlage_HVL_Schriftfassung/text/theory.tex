...
In order to find the maximum of tan($\delta_{pol}$), the second part of the term above, i.e. \eqref{eg:test}  will be set equal to 0.
...
\begin{equation}
	SNR=P_{signal}/P_{noise} = \left[\frac{V_{signal}}{V_{noise}}\right]^2
\end{equation}
